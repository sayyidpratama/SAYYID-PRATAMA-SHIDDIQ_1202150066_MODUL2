...
public class MenuAdapter extends
    ...
    public MenuViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View mItemView = mInflater.inflate(R.layout.activity_detail, parent, false);
    ...
    class MenuViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MenuViewHolder(final View itemView, MenuAdapter adapter) {
            super(itemView);
            foodItemView = (TextView)itemView.findViewById(R.id.nama_food);
            priceItemView = (TextView)itemView.findViewById(R.id.jumlah_price);
            photoItemView = (ImageView)itemView.findViewById(R.id.img_photo);
